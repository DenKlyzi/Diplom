...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Добавить монитор</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <form action="{{ route('monitors.store') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="diagonal" class="form-control" placeholder="Диагональ">
                </div>

                <div class="form-group">
                    <label>Укажите тип монитора</label>
                    <input type="text" name="monitor_type" class="form-control" placeholder="Тип">
                </div>

                <div class="form-group">
                    <label>Макс. частота кадров</label>
                    <input type="text" name="frame_rate" class="form-control" placeholder="Частота кадров">
                </div>

                <div class="form-group">
                    <label>Игровой монитор</label>
                    <input type="text" name="game_monitor" class="form-control" placeholder="Да/Нет">
                </div>

                <div class="form-group">
                    <label>Укажите время отклика</label>
                    <input type="text" name="response_time" class="form-control" placeholder="Время отклика">
                </div>

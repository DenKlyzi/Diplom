        ...
        <main class="overflow-hidden">
            ...
            <div class="main-pc">
                ...
                <div class="container">
                    ...
                    @foreach($ramsCatalog as $rams)
                    <div class="border-product" style="height: 600px;">
                        <div class="ram-link">
                            <h3>{{ $rams -> title }}</h3>
                            <img src="{{ $rams -> image_url }}">
                            <ul class="description-pc">
                                <li>
                                    <p>Тип памяти {{ $rams -> memory_type }}</p>
                                </li>
                                <li>
                                    <p>Суммарный объем памяти {{ $rams -> total_volume }}</p>
                                </li>
                                <li>
                                    <p>Объем одного модуля памяти {{ $rams -> volume }}</p>
                                </li>
                                <li>
                                    <p>Тактовая частота {{ $rams -> tick_rate }}</p>
                                </li>
                                <li>
                                    <p>Напряжение питания {{ $rams -> voltage }} W</p>
                                </li>
                            </ul>
                            <h4 class="price-pc">{{ $rams -> price }} ₽</h4>
                            <div class="about-button">
                                <a href="{{ route('site.ramprod', ['ram_id' => $rams->id]) }}" class="about-pc">Подробнее</a>

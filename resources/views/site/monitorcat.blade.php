        ...
        <main class="overflow-hidden">
            ...
            <div class="main-pc">
                ...
                <div class="container">
                    ...
                    @foreach($monitorsCatalog as $monitors)
                    <div class="border-product" style="height: 600px;">
                        <div class="monitor-link">
                            <h3>{{ $monitors -> title }}</h3>
                            <img src="{{ $monitors -> image_url }}">
                            <ul class="description-pc">
                                <li>
                                    <p>Диагональ {{ $monitors -> diagonal }}</p>
                                </li>
                                <li>
                                    <p>Тип монитора {{ $monitors -> monitor_type }}</p>
                                </li>
                                <li>
                                    <p>Макс. частота кадров {{ $monitors -> frame_rate }}</p>
                                </li>
                                <li>
                                    <p>Игровой монитор {{ $monitors -> game_monitor }}</p>
                                </li>
                                <li>
                                    <p>Время отклика {{ $monitors -> response_time }}</p>
                                </li>
                            </ul>
                            <h4 class="price-pc">{{ $monitors -> price }} ₽</h4>
                            <div class="about-button">
                                <a href="{{ route('site.monitorprod', ['monitor_id' => $monitors->id]) }}" class="about-pc">Подробнее</a>

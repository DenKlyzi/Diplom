        ...
        <main class="overflow-hidden">
            ...
            <div class="main-pc">
                ...
                <div class="container">
                    ...
                    @foreach($peripherysCatalog as $peripherys)
                    <div class="border-product" style="height: 600px;">
                        <div class="periphery-link">
                            <h3>{{ $peripherys -> title }}</h3>
                            <img src="{{ $peripherys -> image_url }}">
                            <ul class="description-pc">
                                <li>
                                    <p>Бренд {{ $peripherys -> characteristicOne }}</p>
                                </li>
                                <li>
                                    <p>Тип товара {{ $peripherys -> characteristicTwo }}</p>
                                </li>
                                <li>
                                    <p>Вес упаковки {{ $peripherys -> characteristicThree }}</p>
                                </li>
                                <li>
                                    <p>Габариты упаковки {{ $peripherys -> characteristicFour }}</p>
                                </li>
                                <li>
                                    <p>Гарантия {{ $peripherys -> characteristicFive }}</p>
                                </li>
                            </ul>
                            <h4 class="price-pc">{{ $peripherys -> price }} ₽</h4>
                            <div class="about-button">
                                <a href="{{ route('site.peripheryprod', ['periphery_id' => $peripherys->id]) }}" class="about-pc">Подробнее</a>
                            </div>
                        </div>
                    </div>
                    @endforeach

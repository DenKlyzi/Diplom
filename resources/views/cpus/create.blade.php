...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Добавить процессор</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <form action="{{ route('cpus.store') }}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="socket" class="form-control" placeholder="Сокет">
                </div>

                <div class="form-group">
                    <label>Укажите дату релиза</label>
                    <input type="text" name="release" class="form-control" placeholder="Дата">
                </div>

                <div class="form-group">
                    <label>Укажите количество ядер</label>
                    <input type="text" name="cores" class="form-control" placeholder="Кол-во ядер">
                </div>

                <div class="form-group">
                    <label>Укажите количество потоков</label>
                    <input type="text" name="streams" class="form-control" placeholder="Кол-во потоков">
                </div>

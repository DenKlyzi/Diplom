...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Добавить другое</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <form action="{{ route('others.store') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="characteristicOne" class="form-control" placeholder="Бренд">
                </div>

                <div class="form-group">
                    <label>Тип товара</label>
                    <input type="text" name="characteristicTwo" class="form-control" placeholder="Тип">
                </div>

                <div class="form-group">
                    <label>Вес упаковки</label>
                    <input type="text" name="characteristicThree" class="form-control" placeholder="Вес">
                </div>

                <div class="form-group">
                    <label>Габариты упаковки</label>
                    <input type="text" name="characteristicFour" class="form-control" placeholder="Габариты">
                </div>

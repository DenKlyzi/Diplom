...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Добавить видеокарту</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <form action="{{ route('gpus.store') }}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tick_rate" class="form-control" placeholder="Частота видеочипа">
                </div>

                <div class="form-group">
                    <label>Турбочастота</label>
                    <input type="text" name="turbo_rate" class="form-control" placeholder="Турбочастота">
                </div>

                <div class="form-group">
                    <label>Интерфейсы подключения</label>
                    <input type="text" name="connect_port" class="form-control" placeholder="Интерфейс подключения">
                </div>

                <div class="form-group">
                    <label>Объем видеопамяти</label>
                    <input type="text" name="video_memory" class="form-control" placeholder="Объем видеопамяти">
                </div>
